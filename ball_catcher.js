  ...
  constructor(canvasSelector) {
    ...
    class BallBouncer {
      ...
      drawGameName() {
        ...
        if (!this.gameStarted) {
          // Display "Enter to Start" message at the center of the canvas
      ...
      drawStopwatch() {
        ...
        if (this.gameStarted) {
          ...
          this.ctx.lineTo(
            this.stopwatchX +
              this.stopwatchRadius * Math.cos((2 * Math.PI * this.getSecondsElapsed()) / 60 - Math.PI / 2),
            this.stopwatchY +
              this.stopwatchRadius * Math.sin((2 * Math.PI * this.getSecondsElapsed()) / 60 - Math.PI / 2)
          );
          this.ctx.stroke();
        }
